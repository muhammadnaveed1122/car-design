import { Grid, Modal, Table, ScrollArea, Group, Text, TextInput, rem, Box, Button } from '@mantine/core';
    ...
    <>
      ...
      <ScrollArea>
        <Box style={{ overflow: "hidden" }}>
          <Grid px={{ sm: 0, xs: '15' }}>
            <Grid.Col span={{ sm: 10 }} offset={{ sm: 1 }} mt="xl">
              <Group justify="space-between" my="md">
                ...
                <Box style={{ textAlign: 'right' }}>
                  <Link href="/admin/trash-user"><Button> Trash User</Button></Link>
                </Box>
              </Group>
            </Grid.Col>
